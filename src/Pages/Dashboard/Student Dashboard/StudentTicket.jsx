    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12 col-12">
          <h2 className="breadcrumb-title mb-2">Support Tickets</h2>
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-xl-4">
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      <span className="icon-box bg-secondary-transparent me-3 flex-shrink-0"><img src="assets/img/icon/book.svg" alt /></span>
                      <div>
              ...
              <div className="col-md-6 col-xl-4">
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      <span className="icon-box bg-success-transparent me-3 flex-shrink-0"><img src="assets/img/icon/bookmark.svg" alt /></span>
                      <div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <a href="#" className="d-inline-flex fs-14 me-1 action-icon" data-bs-toggle="modal" data-bs-target="#edit_ticket"><i className="isax isax-edit-2" /></a>
        ...
        <div className="modal-body text-center custom-modal-body">
          ...
          <div>
            ...
            <div className="d-flex align-items-center justify-content-center">
              ...
              <a href="#" className="btn btn-secondary rounded-pill">Yes, Delete</a>
            </div>
          </div>
        </div>
      </div>
