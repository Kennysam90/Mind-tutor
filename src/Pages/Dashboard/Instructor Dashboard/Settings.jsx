            ...
            <div className="card">
              <div className="card-body">									
                <div className="profile-upload-group">									
                  <div className="d-flex align-items-center">
                    <a href="student-profile.html" className="avatar flex-shrink-0 avatar-xxxl avatar-rounded border me-3"><img src="assets/img/user/user-01.jpg" alt="Img" className="img-fluid" /></a>
                ...
                <div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-12">                                                    
                      ...
                      <a href="javascript:void(0);" className="d-inline-flex align-items-center text-secondary fw-medium mb-3" id="add-new-topic-btn">
                    ...
                    <div className="col-md-12">                                                    
                      ...
                      <a href="javascript:void(0);" className="d-inline-flex align-items-center text-secondary fw-medium mb-3" id="add-new-topic-btn2">
                        <i className="isax isax-add me-1" /> Add New
                      </a>
                    </div>
                    <div className="col-md-12">
