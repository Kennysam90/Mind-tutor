    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12 col-12">
          <h2 className="breadcrumb-title mb-2">Assignments</h2>
      ...
      <div className="row">
        ...
        <div className="col-lg-9">
          <div className="page-title d-flex align-items-center justify-content-between">
            ...
            <div>
              <a href="javascript:void(0);" className="btn btn-secondary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_assignment">
                <i className="isax isax-add-circle me-1" />Add Assignment
              </a>
            </div>
          </div>
          <div className="row">
            ...
            <table className="table">
              ...
              <tbody>
                <tr>
                  <td>
                    <div>
                      <h6 className="mb-1"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#view_assignment">Building Your First Landing Page</a></h6>
                  ...
                  <td>
                    <div className="d-flex align-items-center">
                      <a href="javascript:void(0);" className="d-inline-flex fs-14 me-1 action-icon"><i className="isax isax-edit-2" data-bs-toggle="modal" data-bs-target="#edit_assignment" /></a>
                ...
                <tr>
                  <td>
                    <div>
                      <h6 className="mb-1"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#view_assignment">Building a Basic Angular Application</a></h6>
                ...
                <tr>
                  <td>
                    <div>
                      <h6 className="mb-1"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#view_assignment">Basic Arithmetic Operations</a></h6>
                ...
                <tr>
                  <td>
                    <div>
                      <h6 className="mb-1 fw-medium"><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#view_assignment">Basic Calculations</a></h6>
                ...
                <div className="footer-widget footer-contact">
                  ...
                  <div className="footer-contact-info">
                    ...
                    <div className="footer-address d-flex align-items-center">
                      ...
                      <p><a href="https://dreamslms.dreamstechnologies.com/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="17736572767a647b7a6457726f767a677b723974787a">[email&nbsp;protected]</a></p>
                    </div>
                    <div className="footer-address d-flex align-items-center">
  ...
  <div className="modal fade" id="add_assignment">
    <div className="modal-dialog modal-dialog-centered modal-lg">
      <div className="modal-content">
        ...
        <form action="https://dreamslms.dreamstechnologies.com/html/template/instructor-assignment.html">
          <div className="modal-body pb-0">
            <div className="row">
              ...
              <div className="col-md-12">
                <div className="mb-3">
                  <label className="form-label">Assingment Title <span className="text-danger"> *</span></label>
              ...
              <div className="col-md-12">
                <div className="mb-3">
                  ...
                  <textarea rows={4} className="form-control" defaultValue={"Enter Instructions"} />
                </div>
              </div>
              <div className="col-md-6">
                <div className="mb-3">
                  <label className="form-label">Last Date <span className="text-danger"> *</span></label>
          ...
          <div className="modal-body">
            <div className="row">
              ...
              <div className="col-md-12">
                <div className="mb-3">
                  <label className="form-label">Assingment Title <span className="text-danger"> *</span></label>
                  <input type="text" className="form-control" defaultValue="Building Your First Landing Page" />
                </div>
              </div>
              <div className="col-md-12">
                <div className="mb-3">
      ...
      <div className="modal-content">
        <div className="modal-body text-center custom-modal-body">
          ...
          <div>
            ...
            <p className="mb-3">Are you sure you want to delete assignments?</p>
