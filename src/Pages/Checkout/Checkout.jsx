    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12 col-12">
          <h2 className="breadcrumb-title mb-2">Checkout</h2>
            ...
            <div className="checkout-item-1">
              ...
              <ul className="nav-tabs mb-3 nav-justified border-0 nav-style-1 d-sm-flex d-block" role="tablist">
                <li className="nav-item active">
                  <a className="btn nav-link p-3 active" data-bs-toggle="tab" role="tab" href="#overview" aria-selected="false">
                    <div className="d-flex justify-content-center align-items-center">
                      <img src="assets/img/icons/card.svg" alt="card" className="img-fluid me-2" />
                      <p className="fw-medium">Card</p>
                    </div>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="btn nav-link p-3" data-bs-toggle="tab" role="tab" href="#notes" aria-selected="false">
                    <div className="d-flex justify-content-center align-items-center">
                      <img src="assets/img/icons/paypal-2.svg" alt="card" className="img-fluid me-2" />
                      <p className="fw-medium">Paypal</p>
                    </div>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="btn nav-link p-3" data-bs-toggle="tab" role="tab" href="#faq" aria-selected="true">
                    <div className="d-flex justify-content-center align-items-center">
                      <img src="assets/img/icons/stripe.svg" alt="card" className="img-fluid me-2" />
              ...
              <div className="tab-content">
                <div className="tab-pane active show" id="overview" role="tabpanel">
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="input-block">
                        <label className="form-label">Name on Card<span className="text-danger ms-1">*</span></label>
                        <input type="text" className="form-control" />
                      </div>
                    </div>
                    <div className="col-md-6">
                    ...
                    <div className="col-md-6">
                      <div className="input-block">
                        <label className="form-label">Security Number<span className="text-danger ms-1">*</span></label>
                        <input type="text" className="form-control" />
                      </div>
                    </div>
                    <div className="col-md-12">
                      <div className="d-flex align-items-center justify-content-end">
                        <a href="#" className="btn btn-secondary rounded-pill">Pay $200.25</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="checkout-item-2">
              ...
              <div className="checkout-item-3 bg-light p-3 rounded-3 border mb-3">
                <div className="row row-gap-2 mb-3">
                  <div className="col-md-12 d-flex align-items-center">
                    <div className="order-img flex-shrink-0 me-3">
                      <img src="assets/img/course/course-01.jpg" alt="img" className="img-fluid h-100 w-100" />
                      <a href="javascript:void(0);" className="btn p-1 rounded-circle"><i className="isax isax-trash" /></a>
                    </div>
                    <div>
                      <h6 className="mb-2"><a href="course-details.html">Information About UI/UX Design Degree</a></h6>
                ...
                <div className="row row-gap-2">
                  <div className="col-md-12 d-flex align-items-center">
                    <div className="order-img flex-shrink-0 me-3">
                      <img src="assets/img/course/course-03.jpg" alt="img" className="img-fluid h-100 w-100" />
                      <a href="javascript:void(0);" className="btn p-1 rounded-circle"><i className="isax isax-trash" /></a>
                    </div>
                    <div>
                      <h6 className="mb-2"><a href="course-details.html">Sketch from A to Z (2024): Become an app designer</a></h6>
